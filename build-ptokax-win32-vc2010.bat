...
rem "%VS100COMNTOOLS%..\ide\devenv" PtokaX-gui.sln /Rebuild "Release|Win32"
...
rem SYMUPLOAD 70D71CA7-8FDF-41C4-9AA1-4ADB30527A54 0.5.0.1 0 .\compiled\PtokaX-gui.pdb
rem SYMUPLOAD 70D71CA7-8FDF-41C4-9AA1-4ADB30527A54 0.5.0.1 0 .\compiled\PtokaX-gui.exe
